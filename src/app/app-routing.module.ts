...
const routes: Routes = [
  ...
  { path: 'seller-dashboard', loadChildren: () => import('./seller/dashboard/seller-dashboard.module').then(m => m.SellerDashboardModule) },
  { path: 'seller-products', loadChildren: () => import('./seller/product-list/seller-product-list.module').then(m => m.SellerProductListModule) },
  { path: 'seller-orders', loadChildren: () => import('./seller/orders/seller-orders.module').then(m => m.SellerOrdersModule) },
